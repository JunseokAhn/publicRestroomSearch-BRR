					...
					<div class="card shadow">
						...
						<form action="snsWrite" method="post" onsubmit="return formCheck()">
							<div class="mx-auto boardTitle form-group">
								<input type="hidden" value="${sessionScope.sessionId}" name="id"> <input type="hidden" value="${sessionScope.sessionEmail}" name="email"> <label for="exampleFormControlInput1">제목</label> <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="제목을 입력해주세요." name="title">
							</div>

							<div class="mx-auto boardContents form-group">
								<label for="exampleFormControlTextarea1">내용</label>
								<textarea class="form-control" id="exampleFormControlTextarea1" rows="15" name="contents" placeholder="내용을 입력해주세요."></textarea>
							</div>

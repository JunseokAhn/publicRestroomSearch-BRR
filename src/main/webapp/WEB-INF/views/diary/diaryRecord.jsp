				...
				<c:otherwise>
					<td class="normal_day">
						...
						<c:forEach var="scheduleList" items="${dateList.schedule_data_arr}" varStatus="schedule_data_arr_status"> 
							...
							<img id="type1brown" src="../resources/img/dangerous.png"  style="width:10%"  />
							</c:if> 
							<c:if test="${scheduleList.status==3}">
							<img id="type1brown" src="../resources/img/good.png"  style="width:10%"  />
							</c:if> 

...
<td id='resvalue' style="display:none">11</td> 
<td>
<img id="type3red" src="../resources/img/dangerous.png"  style="width:60%"  />
</td>
<td>
 <p>수분이 부족하여, 딱딱한 덩어리로 인한 <strong>출혈</strong> 등이 있을 수 있음으로 수시로 물과 섬유질을 섭취해 주세요</p>
</td>
</tr>
</table>
<input type="hidden" name="status" value="2">
<input type="hidden" name="resnum" value="11">

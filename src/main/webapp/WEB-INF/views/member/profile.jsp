				...
				<div class="card-header bg-transparent">
					...
					<div class="card-body2">
						...
						<table id="result_table" hidden="hidden">
							<tr>
								<td><img id="result_picture" src="" style="width: 100%" /></td>
			...
			<div class="collapse navbar-collapse" id="sidenav-collapse-main">
				...
				<ul class="navbar-nav">
					...
					<c:if test="${sessionScope.sessionId == null }">
						...
						<li class="nav-item"><a class="nav-link active" href="<c:url value="/member/profile"/>">
...
<!-- 				
	...
	<div class="main-content">
		...
		<nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
			<div class="container-fluid">
				<!-- Brand -->
				<a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="<c:url value="/member/profile"/>">USER PROFILE</a>
				<!-- Form -->
				...
				<div class="row">
					<div class="col-lg-7 col-md-10">
						<c:if test="${sessionScope.sessionNaver != null}">
							...
							<p class="text-white mt-0 mb-5">${sessionScope.sessionNickname}님brr를 이용해 주셔서 감사합니다.</p>
						</c:if>
		...
		<div class="container-fluid mt--7" style="width: 1600px; margin: 0 auto;">
										...
										<div class="col-lg-6">
											<div class="form-group">
												<c:if test="${sessionScope.sessionNaver != null}">
													...
													<input type="text" id="input-username" class="form-control form-control-alternative" placeholder="Username" value="${sessionScope.sessionNickname}">
												</c:if>
												<c:if test="${sessionScope.sessionGooglename != null}">
													<label class="form-control-label" for="input-username">Username</label>
													<input type="text" id="input-username" class="form-control form-control-alternative" placeholder="Username" value="${sessionScope.sessionGooglename}">
												</c:if>
											</div>
										</div>
										<div class="col-lg-6">
			...
			<form name="calendarFrm" id="calendarFrm" action="" method="GET"></form>

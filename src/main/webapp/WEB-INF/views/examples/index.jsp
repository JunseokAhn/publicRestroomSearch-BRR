...
<body class="">
	<nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
		<div class="container-fluid">
			...
			<!-- Brand -->
			<a class="navbar-brand pt-0" href="/index"> <img src="<c:url value="/resources/assets/img/brand/blue.png"/>" class="navbar-brand-img" alt="...">
			</a>
			<!-- User -->
			...
			<div class="collapse navbar-collapse" id="sidenav-collapse-main">
				...
				<!-- Navigation -->
				<ul class="navbar-nav">
					<li class="nav-item  active "><a class="nav-link  active " href="<c:url value="/examples/index"/>"> <i class="ni ni-tv-2 text-primary"></i> Dashboard
					</a></li>
	...
	<div class="main-content">
		...
		<nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
			<div class="container-fluid">
				<!-- Brand -->
				<a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="<c:url value="/examples/index"/>">Dashboard</a>
				<!-- Form -->
	...
	<!--   Optional JS   -->
	<script src="<c:url value="/resources/assets/js/plugins/chart.js/dist/Chart.min.js"/>"></script>
	<script src="<c:url value="/resources/assets/js/plugins/chart.js/dist/Chart.extension.js"/>"></script>
	<!--   Argon JS   -->

...
<body>
	...
	<div class="main-content">
		...
		<nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
			<div class="container-fluid">
				<!-- Brand -->
				<a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="<c:url value="/examples/index"/>">Documentation</a>
				<!-- Form -->
	...
	<!-- Argon JS -->
	<script src="<c:url value="/resources/assets/js/argon-dashboard.js?v=1.0.0"/>"></script>
</body>
